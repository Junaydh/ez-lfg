...
router.post('/create/host/:userId', (req, res) => {
  ...
  const { game_id, title, description, max_players, mic_required, platform, region, competitive } = req.body;
  const sessionDetails = { game_id, mic_required, max_players, title, description, platform, region, competitive };
